...
const _processor = require('./processor')

const _processor2 = _interopRequireDefault(_processor)
...
const _vendor2 = _interopRequireDefault(_vendor)
...
postcss.plugin = function plugin(name, initializer) {
  const creator = function creator() {
    const transformer = initializer(...arguments)
