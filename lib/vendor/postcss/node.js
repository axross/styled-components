...
const _cssSyntaxError = require('./css-syntax-error')

const _cssSyntaxError2 = _interopRequireDefault(_cssSyntaxError)
...
const Node = (function () {
     ...
     */
  function Node() {
    const defaults = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}
  ...
  _createClass(Node, [{
    ...
    value: function toString() {
      let stringifier = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _stringify2.default
    ...
    value: function replaceWith() {
      ...
      value: function raw(prop, defaultType) {
        const str = new _stringifier2.default()
