...
const objToCss = exports.objToCss = function objToCss(obj, prevKey) {
...
const flatten = function flatten(chunks, executionContext) {
  return chunks.reduce((ruleSet, chunk) => {
    ...
    if (typeof chunk === 'function') {
      return executionContext ? ruleSet.concat(..._toConsumableArray(flatten([chunk(executionContext)], executionContext))) : ruleSet.concat(chunk)
    }
